...
public class ExperiencesController {
	...
	public DataResult<List<Experience>> getAllByCandidateIdOrderByEndAtDesc(@RequestParam("id") int id){
		return this.experienceService.getAllByCandidateIdOrderByEndAtDesc(id);
	}
	
	@GetMapping("/getAllByCandidateId")
	public DataResult<List<Experience>> getAllByCandidateId(@RequestParam int id){
		return this.experienceService.getAllByCandidateId(id);
	}
