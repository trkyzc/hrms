...
public class JobPositionManager implements JobPositionService {
	...
	public Result add(JobPosition jobPosition) {
		...
		var result = getJobByTitle(jobPosition.getJobTitle());
		if (result != null) {
	...
	public DataResult<List<JobPosition>> getAll() {
		...
		return new SuccessDataResult<List<JobPosition>>(this.jobPositionDao.findAll(), "Job Positions has been listed.") ;
	}

	@Override
	public DataResult<JobPosition> getJobByTitle(String title) {
		
		return new SuccessDataResult<JobPosition>(this.jobPositionDao.findByJobTitle(title), "Job Position has been showed.") ;
