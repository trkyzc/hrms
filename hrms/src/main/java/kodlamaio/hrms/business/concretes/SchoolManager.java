...
public class SchoolManager implements SchoolService {
	...
	@Override
	public DataResult<List<School>> getAllByCandidateIdOrderByEndAtDesc(int id) {
		return new SuccessDataResult<List<School>>(this.schoolDao.getAllByCandidate_idOrderByEndAtDesc(id));
	}
